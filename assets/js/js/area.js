...
function consultar() {
    var clasificacion = document.getElementById("areaClasificacion").value;
    ...
    $.ajax({
        ...
        var contenedor = document.getElementById("listarAreaClasificacion");
        contenedor.innerHTML = "";
        for (i = 0; i < activo.length; i++) {
            agregarActivo(activo[i]);
        }
        if (activo.length == 0) {
            crearTr(16, "listarAreaClasificacion");
        }
    })
}
